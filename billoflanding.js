        ...
        forEachInArray(tempArr, function (item) {
           // result = 5;
            ...
            switch (currentRelatedObj.DbClassType) {
                ...
                case 3: //WR
                case 4: //CR
                    result = "Puntos 2,3,4 " + currentRelatedObj.Number;
                    break;
                case 5: //SH
                    result = hasValue(currentRelatedObj.AirWaybillNumber) ? "Puntos 5 AirWaybillNumbe " + currentRelatedObj.AirWaybillNumber : 
                    hasValue(currentRelatedObj.BillOfLadingNumber) ? "Puntos 5 BillOfLadingNumber " + currentRelatedObj.BillOfLadingNumber : "Puntos 5 Name " + currentRelatedObj.Name;
                    break;
                default:
                    result = "Puntos 5 default " + currentRelatedObj.Number;
                    break;
            }
            return false;
        });
