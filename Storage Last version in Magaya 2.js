function getStorageCharges() {
    ...
    var volPrice = hasValue(curObj.Division) ? curObj.Division.CustomFields.tarifa : 0; // This is the W/M Price for Storage 18 solo para CBM 120 para Ton
    var weightPrice = hasValue(curObj.Division) ? curObj.Division.CustomFields.tarifa_kg : 0;
    ...
    forEachInArray(uniWRs, function (uniWR) {
        ...
        var wgtKg = uniWR.TotalWeight.convertTo(dbx.Uom.Weight.Kilogram).magnitude;
        ...
        var costPerKg = weightPrice * wgtKg; //New tarifas 
        var costPerM3 = volPrice * volCBMS;
